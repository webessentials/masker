...
class Masker
  ...
  # Make a new Masker object.  Pass in a configuration structure to define how the obfuscation should be
...
require 'masker/copy_statement_parser'
require 'masker/insert_statement_parser'
require 'masker/config_scaffold_generator'
require 'masker/mysql'
require 'masker/sql_server'
require 'masker/postgres'
require 'masker/config_applicator'
