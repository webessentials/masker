...
describe Masker do
  describe "Masker.reassembling_each_insert" do
    before do
    ...
    it "should yield each subinsert and reassemble the result" do
      count = 0
      reassembled = Masker.new.reassembling_each_insert(@test_insert, "some_table", @column_names) do |sub_insert|
      ...
      let(:obfuscator) do
        Masker.new({
          :some_table => {
            ...
            :name => {:type => :string, :length => 8, :chars => Masker::USERNAME_CHARS},
